...
class ProductCategory(Base):
    ...
    id:Mapped[str]=mapped_column(String(36),primary_key=True,default=uid);organisation_id:Mapped[str]=mapped_column(ForeignKey("organisations.id"),index=True);name:Mapped[str]=mapped_column(String(100));created_at:Mapped[datetime]=mapped_column(DateTime,default=datetime.utcnow)
...
class SystemSetting(Base):
    ...
    id:Mapped[str]=mapped_column(String(36),primary_key=True,default=uid);key:Mapped[str]=mapped_column(String(100),unique=True);value:Mapped[str]=mapped_column(Text);updated_at:Mapped[datetime]=mapped_column(DateTime,default=datetime.utcnow,onupdate=datetime.utcnow)
